...
import ExSlider from "../components/expslider1";
...
return(
    ...
    <>
        ...
        <div className=" container experiences-banner">
                       ...
                       >
                         <div className="lux-heading  ">
                           <div className="lg:mt-5 mt-36 ">
                                   <h1 className="text-[40px] font-[400]  subpixel-antialiased mb-0"> The SR haven Experiences </h1>
