...
return(
  ...
  <div className="container cn3 ">
       ...
       <div className="container">
            ...
            <div className="container mt-7 lg:flex  lg:px-20 px-3 gap-14">
              <div className="">
        <div
         ...
         <img
          ...
          <div className="card-body pb-5 ">
            <p className="p1 text-[1.3rem] ps-3 pt-3">
              {" "}
           Heaven Advantage Rate<br/> <span className="text-[1rem]"> Preferred Guest Savings</span>
            </p>
          </div>
        </div>
      </div>
          <div className="">
        <div
          className="card lg:mt-0 mt-10 bg-transparent"
        >
          <div className="card-img">
         <img
          ...
          <div className="card-body pb-5">
            <p className="p1 text-[1.3rem] ps-3 pt-3">
              {" "}
            Executive Stay<br/> <span className="text-[1rem]">Business Class Stay</span>
            </p>
        ...
        >
         ...
         <img
          ...
          <div className="card-body pb-5">
            <p className="p1 text-[1.3rem] ps-3 pt-3">
              {" "}
        SR Heaven Getaway <br/> <span className="text-[1rem]"> Stay • Relax • Refresh</span>
            </p>
   ...
   <div className="container lg:flex  lg:px-20 px-3  gap-14  lg:mt-15 lg:mt-15">
              <div className="">
        <div
          className="card  lg:mt-0 mt-10 bg-transparent "
        >
          <div className="card-img">
         <img
              src="/images/rooms/coupleroom.jpg"
              className="Manaliimg"
              alt="..." 
            />
          </div>
          <div className="card-body pb-5 ">
            <p className="p1 text-[1.3rem] ps-3 pt-3">
              {" "}
           Premium Couple Stay Package <br/> <span className="text-[1rem]">  Signature Experience</span>
            </p>
          </div>
        </div>
      </div>
        ...
        >
         ...
         <img
          ...
          <div className="card-body pb-5">
            <p className="p1 text-[1.3rem] ps-3 pt-3">
              {" "}
          Family Comfort Package<br/> <span className="text-[1rem]">Extended Room Benefits</span>
            </p>
        ...
        >
         ...
         <img
          ...
          <div className="card-body pb-5 ">
            <p className="p1 text-[1.3rem] ps-3 pt-3">
              {" "}
              Long Stay Special <br/> <span className="text-[1rem]">Stay Longer, Save More</span>
            </p>
       ...
       <div className="px-3">
          <div className="row cn6">
            ...
            <div className="col offers2  text-center ">
              ...
              <p class="p2 lg:px-46 px-2 mt-1"> Every SR Heavent Hotel has unique experiences for you to explore. From recreational activities, romantic sunset dining set-ups, cultural programmes to our exclusive Trident Kids Club, we ensure you leave us with a feeling of newness in your heart. </p>
