         ...
         <img
          ...
          <div className="card-body pb-5 ">
            <p className="p1 text-[1.3rem] ps-3 pt-3">
              {" "}
             Meeting<br/> <span className="text-[1rem]"> Explore </span>
            </p>
          </div>
        </div>
      </div>
        ...
        >
         ...
         <img
          ...
          <div className="card-body pb-5 ">
            <p className="p1 text-[1.3rem] ps-3 pt-3">
              {" "}
            Conferences<br/> <span className="text-[1rem]">Explore </span>
            </p>
        ...
        >
         ...
         <img
          ...
          <div className="card-body pb-5 ">
            <p className="p1 text-[1.3rem] ps-3 pt-3">
              {" "}
             Events <br/> <span className="text-[1rem]">Explore</span>
            </p>
          </div>
        </div>
      </div>
...
<div className="container">
                  <div className="  lg:px-18 px-3">
                   ...
                   >
                     <div className="lux-heading  ">
                       <div className="mt-5 ">
                               <h1 className="text-[40px] font-[400]  subpixel-antialiased mb-0"> SR Heaven Advantage </h1>
           ...
           `}
                       >
                        ...
                        <div className="container lg:flex  lg:px-40 px-3  gap-14  lg:mt-15 lg:mt-15">
        ...
        >
          <div className="card-img">
         <img
              src="/images/rooms/accomodation.jpg"
              className="Manaliimg"
              alt="..." 
            />
          </div>
          <div className="card-body pb-5 ">
            <p className="p1 text-[1.3rem] ps-3 pt-3">
              {" "}
           Accomodation <br/> <span className="text-[1rem]">  Explore </span>
            </p>
          </div>
        </div>
      </div>
        ...
        >
          <div className="card-img">
         <img
              src="/images/rooms/restuarants.jpg"
              className="Manaliimg"
              alt="..." 
            />
          ...
          <div className="card-body pb-5">
            <p className="p1 text-[1.3rem] ps-3 pt-3">
              {" "}
          Restraurants<br/> <span className="text-[1rem]">Explore</span>
            </p>
